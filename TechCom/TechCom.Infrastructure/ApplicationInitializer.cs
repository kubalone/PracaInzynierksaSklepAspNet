...
namespace TechCom.Infrastructure
{
    public class ApplicationInitializer : MigrateDatabaseToLatestVersion<ApplicationDbContext, Configuration>
    {
        public static void SeedAppData(ApplicationDbContext context)
        {
            ...
            {
                new Product() {ProductID=1, CategoryID=1, Name="Asus Z370", Description="Komputer stacjonarny firmy Asus",Quantity=10, Manufacturer="Asus", Price=2700, ProductWithDiscount=true,ImageProduct="AsusZ370.jpg", DateAdded=DateTime.Now   },
                new Product() {ProductID=2, CategoryID=2, Name="Lenovo MIIX 30-10", Description="Laptop firmy Lenovo",Quantity=10, Manufacturer="Lenovo", Price=3700, ProductWithDiscount=false,ImageProduct="Lenovo MIIX 30-10.jpg", DateAdded=DateTime.Now   },
                new Product() {ProductID=3, CategoryID=3, Name="DYSK TWARDY WD BLUE 250GB", Description="DYSK TWARDY WD BLUE 250GB 7200obr SATA 3,5''",Quantity=10, Manufacturer="HP", Price=29, ProductWithDiscount=false,ImageProduct="WdBLUE.jpg", DateAdded=DateTime.Now   },
                new Product() {ProductID=4, CategoryID=4, Name="KAMERA SPORTOWA Go-Pro HD WODOODPORNA", Description="Wielofunkcyjna kamera. Umożliwia nagrywanie filmów podczas uprawiania sportów ekstremalnych lub używania jako rejestratora jazdy w samochodzie i na motorze.",Quantity=10, Manufacturer="GoPro", Price=200, ProductWithDiscount=false,ImageProduct="gopro.jpg", DateAdded=DateTime.Now   },
                new Product() {ProductID=5, CategoryID=5, Name="Klawiatura Genesis Thor 300 TKL Blue", Description="Thor 300 TKL powstało z myślą o nich. TKL to skrót od Tenkeyless Mechanical Keyboard, czyli mechanicznej klawiatury bez części numerycznej. To właśnie kompaktowe rozmiary czynią Thor 300 TKL idealnym urządzeniem do zabrania ze sobą.",Quantity=10, Manufacturer="Genesis", Price=70, ProductWithDiscount=true,ImageProduct="Genesis.jpg", DateAdded=DateTime.Now  },
                new Product() {ProductID=6, CategoryID=1, Name="Asus ZZ480", Description="Komputer stacjonarny Asus z systemem windows 10",Quantity=10, Manufacturer="Asus", Price=8700, ProductWithDiscount=true,ImageProduct="AsusZ370.jpg", DateAdded=DateTime.Now   },
                new Product() {ProductID=7, CategoryID=2, Name="Asus ZZ410", Description="Laptop Asus z systemem windows 8",Quantity=10, Manufacturer="Asus", Price=8700, ProductWithDiscount=true,ImageProduct="AsusZ370.jpg", DateAdded=DateTime.Now   },
                new Product() {ProductID=8, CategoryID=1, Name="HP 1940", Description="Komputer z systemem windows 8",Quantity=10, Manufacturer="HP", Price=8700, ProductWithDiscount=true,ImageProduct="AsusZ370.jpg", DateAdded=DateTime.Now   },
                 new Product() {ProductID=9, CategoryID=1, Name="HP 8970", Description="Komputer z systemem windows 10",Quantity=10, Manufacturer="HP", Price=8700, ProductWithDiscount=true,ImageProduct="AsusZ370.jpg", DateAdded=DateTime.Now   }
