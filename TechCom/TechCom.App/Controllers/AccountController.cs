...
namespace TechCom.App.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            {
                ModelState.AddModelError("", "Brak potwierdzenia adresu email.");
                return View(model);
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                   // await SignInManager.SignInAsync(user, isPersistent:false, rememberBrowser:false);
                    ...
                    await UserManager.SendEmailAsync(user.Id, "Potwierdzenie adresu Email", "Please confirm your account by clicking <a href=\"" + callbackUrl + "\">here</a>");

                    return View("CheckYourEmailAccount");
                }
                AddErrors(result);
            }
