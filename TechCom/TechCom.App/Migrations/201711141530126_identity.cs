namespace TechCom.App.Migrations
{
    ...
    public partial class identity : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.OrderDetail", "ApplicationUser_Id", c => c.String(maxLength: 128));
            CreateIndex("dbo.OrderDetail", "ApplicationUser_Id");
            AddForeignKey("dbo.OrderDetail", "ApplicationUser_Id", "dbo.AspNetUsers", "Id");
        }
        ...
        public override void Down()
        {
            ...
            DropColumn("dbo.OrderDetail", "ApplicationUser_Id");
